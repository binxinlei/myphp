...
$id = $_GET['id']??'cctv1';
$n = [
    'cctv1' => 'cctv1hd/4000000',//CCTV-1HD
    'cctv2' => 'cctv2/1300000',//CCTV-2
    'cctv3' => 'cctv3hd/4000000',//CCTV-3HD
    'cctv4' => 'cctv4/1300000',//CCTV-4
    'cctv5' => 'cctv5hd/4000000',//CCTV-5HD
    'cctv5p' => 'cctv5phd/4000000',//CCTV-5+HD2
    'cctv6' => 'cctv6hd/4000000',//CCTV-6HD
    'cctv7' => 'cctv7/1300000',//CCTV-7
    'cctv8' => 'cctv8hd/4000000',//CCTV-8HD
    'cctv9' => 'cctv9/1200000',//CCTV-9
    'cctv10' => 'cctv10hd/4000000',//CCTV-10HD
    'cctv11' => 'cctv11/1300000',//CCTV-11
    'cctv12' => 'cctv12/1300000',//CCTV-12
    'cctv13' => 'cctvxw/1300000',//CCTV-13
    'cctv14' => 'cctvsehd/4000000',//CCTV-14HD
    'cctv15' => 'cctvyy/1300000',//CCTV-15
...
$date = date('YmdH');
$timestamp = substr(time(), 0, 9)-5;//intval((time()-50)/10);
$stream = "http://newpublic.livev5.bestvcdn.com.cn/key/live/program/live/{$n[$id]}/{$date}/";
$current = "#EXTM3U" . PHP_EOL;
$current.= "#EXT-X-VERSION:3" . PHP_EOL;
$current.= "#EXT-X-TARGETDURATION:5" . PHP_EOL;
$current.= "#EXT-X-MEDIA-SEQUENCE:{$timestamp}" . PHP_EOL;
for ($i=0; $i<5; $i++) {
    $current.= "#EXTINF:5.000," . PHP_EOL;
